...
const List<SportsService> kServices = [
  SportsService(id: '0', name: 'Athletics',             description: '', emoji: '🏃‍♀️', tag: 'Sports'),
  SportsService(id: '1', name: 'Badminton',             description: '', emoji: '🏸',   tag: 'Sports'),
  SportsService(id: '2', name: 'Boxing / Kickboxing',   description: '', emoji: '🥊',   tag: 'Sports'),
  SportsService(id: '3', name: 'Cricket',               description: '', emoji: '🏏',   tag: 'Sports'),
  SportsService(id: '4', name: 'Football',              description: '', emoji: '⚽',   tag: 'Sports'),
  SportsService(id: '5', name: 'Karate',                description: '', emoji: '🥋',   tag: 'Sports'),
  SportsService(id: '6', name: 'Kids Sports Training',  description: '', emoji: '⛹🏾‍♀️', tag: 'Sports'),
  SportsService(id: '7', name: 'Running / Marathon',    description: '', emoji: '🏃',   tag: 'Sports'),
  SportsService(id: '8', name: 'Skating',               description: '', emoji: '⛸️',   tag: 'Sports'),
  SportsService(id: '9', name: 'Swimming',              description: '', emoji: '🏊',   tag: 'Sports'),
];
            ...
            children: [
              ...
              Text(
                isOnline
                    ...
                    : 'Home Visit · Sports Trainer comes to you',
                style: TextStyle(
                    fontSize: 11,
                    fontWeight: FontWeight.w700,
                    color: isOnline ? kBlue : kTextDark),
    ...
    return Column(
      ...
      children: [
        ...
        _ModeOption(
          ...
          title: 'Home Visit',
          badgeLabel: 'Popular',
          desc: 'Our certified sports trainer visits your home',
          chips: [
            _FeatureChip(
                icon: Icons.location_on_rounded,
                label: 'Within 15 km',
        ...
        _ModeOption(
          ...
          badgeLabel: 'Anywhere',
          desc: 'Live video call with your sports trainer',
          chips: [
            _FeatureChip(
                  ...
                  children: [
                    Text('Cash Payment Only',
                        style: TextStyle(
                            ...
                            color: kTextDark)),
                    Text(
                        'Pay directly to the sports trainer at session time',
                        style: TextStyle(
                            fontSize: 11,
                            color: kTextMid,
                            height: 1.4)),
        ...
        Container(
          ...
          child: const Row(
            children: [
              ...
              Expanded(
                child: Text(
                    'Our sports trainer will call you within 24 hours — completely FREE!',
                    style: TextStyle(
