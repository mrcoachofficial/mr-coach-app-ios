...
const List<YogaService> kServices = [
  YogaService(id: '0', name: 'Meditation',            description: '',    emoji: '', tag: ''),
  YogaService(id: '1', name: 'Power Yoga',          description: '',          emoji: '', tag: ''),
  YogaService(id: '2', name: ' Pre / Post Pregnancy Yoga',  description: '',       emoji: '', tag: ''),
  YogaService(id: '3', name: 'Stress Relief',                 description: '',            emoji: '', tag: ''),
  YogaService(id: '4', name: 'Therapeutic Yoga',     description: '',        emoji: '', tag: ''),
...
class YogaBooking1Screen extends StatefulWidget {
  ...
  const YogaBooking1Screen({super.key, this.categoryImageUrl});
                  ...
                  child: ListenableBuilder(
                    ...
                    builder: (context, _) {
                      final count = BookingStore.instance.bookings
                          .where((b) =>
                              b.serviceCategory == ServiceCategory.yoga)
                          .length;
                      return Row(
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ...[
                ('🎓', 'Certified Yoga Trainers with 5+ years experience'),
...
class _StepService extends StatelessWidget {
  final YogaService? selected;
  final void Function(YogaService) onSelect;
  const _StepService(
      ...
      children: [
        const Text('Your Details & Address',
            style: TextStyle(
                fontSize: 18, fontWeight: FontWeight.w800, color: kTextDark)),
        const SizedBox(height: 4),
        const Text('Our yoga trainer will visit you at this location',
            style: TextStyle(fontSize: 12, color: kTextLight)),
        const SizedBox(height: 24),
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          style: const TextStyle(fontSize: 14, color: kTextDark),
          decoration: _dec(
              hint: 'e.g. I want to improve my speed — which sport suits me?',
              icon: Icons.help_outline_rounded),
        ),
        const SizedBox(height: 16),
        Container(
