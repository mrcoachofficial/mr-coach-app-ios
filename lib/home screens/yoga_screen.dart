...
const List<YogaService> kServices = [
  YogaService(id: '0', name: 'Meditation',                  description: '', emoji: '🧘'),
  YogaService(id: '1', name: 'Power Yoga',                  description: '', emoji: '🤸'),
  YogaService(id: '2', name: 'Pre / Post Pregnancy Yoga',    description: '', emoji: '🤰'),
  YogaService(id: '3', name: 'Stress Relief',                description: '', emoji: '😌'),
  YogaService(id: '4', name: 'Therapeutic Yoga',             description: '', emoji: '🩺'),
];
...
/// was applied on the Fitness/Sports screen so the slider doesn't flash
...
class YogaBooking1Screen extends StatefulWidget {
  final String? preSelectedServiceName;
  const YogaBooking1Screen({super.key, this.preSelectedServiceName});

  @override
  State<YogaBooking1Screen> createState() => _YogaBooking1ScreenState();
}

class _YogaBooking1ScreenState extends State<YogaBooking1Screen> {
  ...
  void _startBookingWithService(YogaService service) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: (ApiService.cachedDynamicInnerBannerMap?['Yoga'] != null && ApiService.cachedDynamicInnerBannerMap!['Yoga']!.isNotEmpty)
              ? NetworkImage(ApiService.getMediaUrl(ApiService.cachedDynamicInnerBannerMap!['Yoga']!)) as ImageProvider
...
class _ServicesTab extends StatelessWidget {
  final VoidCallback onDemo;
  final VoidCallback onEnquire;
  final void Function(YogaService) onSelectService;
  const _ServicesTab({
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ...[
                ('🎓', 'Certified Yoga Trainers with 5-10+years experience'),
                ('📍', 'Home visits + Online consultations available'),
                ('📋', 'Personalised practice plans, not generic ones'),
...
class _BookingFlowSheet extends StatefulWidget {
  ...
  final YogaService? initialService;
...
class _BookingFlowSheetState extends State<_BookingFlowSheet> {
  ...
  // pattern used on the Fitness/Sports screen.
  final Set<YogaService> _selectedServices = {};
  ...
  void _toggleService(YogaService s) {
    setState(() {
  ...
  void _confirmBooking() async {
    ...
    // model, so — same as Fitness/Sports/Diet — they're folded into the
  ...
  void _submitBookingToBackend({
    ...
    final booking = Booking(
      bookingId:       'YB${DateTime.now().millisecondsSinceEpoch}',
      serviceCategory: ServiceCategory.yoga,
      sourceScreen:    'Yoga',
...
/// same behaviour as the Fitness/Sports screen.
class _StepService extends StatelessWidget {
  final Set<YogaService> selected;
  final void Function(YogaService) onToggle;
  const _StepService(
    ...
    return Column(
      ...
      children: [
        ...
        _ModeOption(
          ...
          title: 'Home Visit',
          badgeLabel: 'Popular',
          desc: 'Our certified yoga trainer visits your home',
          chips: [
            _FeatureChip(
        ...
        _ModeOption(
          ...
          badgeLabel: 'Anywhere',
          desc: 'Live video call with your yoga trainer',
          chips: [
            _FeatureChip(
...
/// Fitness/Sports screen pattern.
class _StepAddress extends StatelessWidget {
  final List<YogaService> selectedServices;
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  isOnline
                      ? 'Online Session · Video Call'
                      : 'Home Visit · Yoga Trainer comes to you',
                  style: TextStyle(
                      fontSize: 12,
                      fontWeight: FontWeight.w700,
                  ...
                  children: [
                    Text('Cash Payment Only',
                        style: TextStyle(
                            ...
                            color: kTextDark)),
                    Text(
                        'Pay directly to the yoga trainer at session time',
                        style: TextStyle(
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          style: const TextStyle(fontSize: 14, color: kTextDark),
          decoration: _dec(
              hint: 'e.g. I want to relieve stress — which plan suits me?',
        ...
        Container(
          ...
          child: const Row(
            children: [
              ...
              Expanded(
                child: Text(
                    'Our yoga trainer will call you within 24 hours — completely FREE!',
                    style: TextStyle(
...
/// the Fitness/Sports screen so the slider doesn't flash different
