...
class TherapyScreen extends StatefulWidget {
  ...
  const TherapyScreen({super.key, this.categoryImageUrl});
                  ...
                  child: ListenableBuilder(
                    ...
                    builder: (context, _) {
                      final count = BookingStore.instance.bookings
                          .where((b) =>
                              b.serviceCategory == ServiceCategory.therapy)
                          .length;
                      return Row(
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ...[
                ('🎓', 'Certified Therapy Trainers with 5+ years experience'),
...
class _BookingFlowSheetState extends State<_BookingFlowSheet> {
  ...
  TherapyService? _selectedService;
...
class _StepService extends StatelessWidget {
  final TherapyService? selected;
  final void Function(TherapyService) onSelect;
  const _StepService(
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('Choose a Therapy Plan',
            style: TextStyle(
      ...
      children: [
        const Text('Your Details & Address',
            style: TextStyle(
                fontSize: 18, fontWeight: FontWeight.w800, color: kTextDark)),
        const SizedBox(height: 4),
        const Text('Our therapy trainer will visit you at this location',
            style: TextStyle(fontSize: 12, color: kTextLight)),
        const SizedBox(height: 24),
