...
const List<TherapyService> kServices = [
  TherapyService(id: '0', name: 'Acupressure',    description: '', emoji: '👐', tag: 'Medical'),
  TherapyService(id: '1', name: 'Acupuncture',    description: '', emoji: '🪡', tag: 'Medical'),
  TherapyService(id: '2', name: 'Cupping Therapy',description: '', emoji: '🫙', tag: 'Fitness'),
  TherapyService(id: '3', name: 'Detox Therapy',  description: '', emoji: '🌿', tag: 'Wellness'),
  TherapyService(id: '4', name: 'Naturopathy',    description: '', emoji: '🍃', tag: 'Wellness'),
  TherapyService(id: '5', name: 'Touch Healing',  description: '', emoji: '🤲', tag: 'Wellness'),
];
...
/// was applied on the Fitness/Sports/Yoga screen so the slider doesn't
/// flash between different colours as the user drags/taps through tiers.
...
class TherapyScreen extends StatefulWidget {
  ...
  const TherapyScreen({super.key, this.preSelectedServiceName});
...
class _TherapyScreenState extends State<TherapyScreen> {
  ...
  void _startBookingWithService(TherapyService service) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: (ApiService.cachedDynamicInnerBannerMap?['Therapy'] != null && ApiService.cachedDynamicInnerBannerMap!['Therapy']!.isNotEmpty)
              ? NetworkImage(ApiService.getMediaUrl(ApiService.cachedDynamicInnerBannerMap!['Therapy']!)) as ImageProvider
...
class _ServicesTab extends StatelessWidget {
  final VoidCallback onDemo;
  final VoidCallback onEnquire;
  final void Function(TherapyService) onSelectService;
  const _ServicesTab({
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ...[
                ('🎓', 'Certified Therapist with 5-10+ years experience'),
...
class _BookingFlowSheet extends StatefulWidget {
  ...
  final TherapyService? initialService;
...
class _BookingFlowSheetState extends State<_BookingFlowSheet> {
  ...
  // pattern used on the Fitness/Sports/Yoga screen.
  final Set<TherapyService> _selectedServices = {};
  ...
  void _toggleService(TherapyService s) {
    setState(() {
  ...
  void _confirmBooking() async {
    ...
    // model, so — same as Fitness/Sports/Yoga/Diet — they're folded into
    // the address string until `Booking` is extended.
  ...
  void _submitBookingToBackend({
    ...
    required TherapyService primary,
    ...
    final booking = Booking(
      ...
      serviceCategory: ServiceCategory.therapy,
      sourceScreen:    'Therapy',
...
/// same behaviour as the Fitness/Sports/Yoga screen.
class _StepService extends StatelessWidget {
  final Set<TherapyService> selected;
  final void Function(TherapyService) onToggle;
  const _StepService(
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('Choose Therapy Plan(s)',
            style: TextStyle(
    ...
    return Column(
      ...
      children: [
        ...
        _ModeOption(
          ...
          title: 'Home Visit',
          badgeLabel: 'Popular',
          desc: 'Our certified therapy trainer visits your home',
          chips: [
            _FeatureChip(
        ...
        _ModeOption(
          ...
          badgeLabel: 'Anywhere',
          desc: 'Live video call with your therapy trainer',
          chips: [
            _FeatureChip(
                icon: Icons.public_rounded, label: 'All India', color: kBlue),
            _FeatureChip(
...
/// Fitness/Sports/Yoga screen pattern.
class _StepAddress extends StatelessWidget {
  final List<TherapyService> selectedServices;
...
class _StepDemoConfirm extends StatelessWidget {
  final List<TherapyService> services;
  final DateTime date;
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  isOnline
                      ? 'Online Session · Video Call'
                      : 'Home Visit · Therapy Trainer comes to you',
                  style: TextStyle(
                      fontSize: 12,
                      fontWeight: FontWeight.w700,
                  ...
                  children: [
                    Text('Cash Payment Only',
                        style: TextStyle(
                            ...
                            color: kTextDark)),
                    Text(
                        'Pay directly to the therapy trainer at session time',
                        style: TextStyle(
                            fontSize: 11,
                            color: kTextMid,
                            height: 1.4)),
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          style: const TextStyle(fontSize: 14, color: kTextDark),
          decoration: _dec(
              hint: 'e.g. I have back pain — which therapy helps?',
        ...
        Container(
          ...
          child: const Row(
            children: [
              ...
              Expanded(
                child: Text(
                    'Our therapy trainer will call you within 24 hours — completely FREE!',
                    style: TextStyle(
...
/// the Fitness/Sports/Yoga screen so the slider doesn't flash different
