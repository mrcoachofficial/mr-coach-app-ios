...
const _kEventTitle    = 'CHENNAI KIDATHON 2026';
const _kEventDate     = 'Sun, 2 Aug 2026 | 7:00 AM';
const _kEventLocation = 'Nehru Park Sports Development Authority of Tamilnadu, Chennai';
const _kEventUrl      = 'https://mrcoach.in/events/kidathon-2026';
const _kShareText     =
...
class Event2DetailPage extends StatefulWidget {
  ...
  @override
  State<Event2DetailPage> createState() => _Event2DetailPageState();
}

class _Event2DetailPageState extends State<Event2DetailPage> {
                    ...
                    onTap: () async {
                      ...
                      if (context.mounted) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content:
                                Text('Event details copied! Paste in Instagram'),
                            behavior: SnackBarBehavior.floating,
            ...
            children: [
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 2),
                        Text(
                          '116-A, Poonamallee High Rd, Sastri Nagar,\nNehru Park, Chennai, Tamil Nadu 600084',
                          style: TextStyle(fontSize: 13, color: kSubText),
                        ),
                      ],
                    ),
                      ...
                      GestureDetector(
                        onTap: () async {
                          await Clipboard.setData(const ClipboardData(
                            text:
                                '116-A, Poonamallee High Rd, Sastri Nagar, Nehru Park, Chennai, Tamil Nadu 600084',
                          ));
                          if (context.mounted) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                        ...
                        child:
                            const Icon(Icons.copy, size: 20, color: kSubText),
                      ),
                      const SizedBox(width: 14),
                      GestureDetector(
                        onTap: () async {
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    const double lat = 13.0785;
                    const double lng = 80.2512;
  ...
  void _showScheduleSheet(BuildContext context) {
    final items = [
      ScheduleItem('Gates open', '6:30 AM'),
      ScheduleItem('Event starts', '7:00 AM'),
      ScheduleItem('Event ends', '2:00 PM'),
    ];
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border:
                                    Border.all(color: kSubText, width: 1.5),
            ...
            Expanded(
              child: ListView(
                ...
                children: const [
                  ...
                  _TermsItem(
                      'The event encourages young runners to stay active, build endurance, and enjoy the thrill of participating in a professionally organized race.'),
                  _TermsItem(
                      'With a safe and energetic environment, kids will experience the joy of running, cheering, and achieving their goals.'),
                  _TermsItem(
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  _ThingsRow(
                      Icons.check_circle_outline, 'Carry your bib on race day'),
                  _ThingsRow(Icons.check_circle_outline,
                      'No refunds once registered'),
                  _ThingsRow(Icons.check_circle_outline,
                      'Report 30 minutes before race start'),
                  _ThingsRow(Icons.check_circle_outline,
      ...
      body: Stack(
        children: [
          SizedBox(
            ...
            width: double.infinity,
            child:
                Image.asset('assets/images/kidathon.jpeg', fit: BoxFit.cover),
          ),
          ...
          Positioned(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child:
                    const Icon(Icons.arrow_back_ios, color: kBlackText, size: 20),
              ),
            ),
          ),
                      ...
                      child: Column(
                        children: [
                          _InfoTile(
                            ...
                            title:
                                'NEHRU PARK Sports Development AUTHORITY OF TAMILNADU, CHENNAI',
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 12),
                          const Text(
                            '🎉🎉 CHENNAI KIDATHON 2026\n\n✨ Presented by Vincera Sports\n\nJoin us for an exciting children\'s run event at Nehru Park, Chennai. A fun-filled day of fitness, energy, and celebration for kids of all ages. Let\'s get Chennai\'s kids running!',
                            style: TextStyle(
                                fontSize: 14, color: kSubText, height: 1.6),
                            maxLines: 4,
                            overflow: TextOverflow.ellipsis,
                          ),
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          _ThingsRow(
                              Icons.translate, 'Event will be in English, Tamil'),
                          const Divider(color: kLightDivider, thickness: 0.5),
                          const SizedBox(height: 12),
                          _ThingsRow(Icons.person_outlined,
                              'Ticket needed for ages 3 and above'),
...
class _TagChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child:
          Text(label, style: const TextStyle(fontSize: 12, color: kBlackText)),
    );
  }
}
...
class _ChooseTicketPageState extends State<ChooseTicketPage> {
  final List<TicketItem> _tickets = [
    TicketItem(title: 'Pre KG - 30 Mts (Run with parent)', price: '₹550'),
    TicketItem(title: 'LKG & UKG 50 Mts', price: '₹550'),
    TicketItem(title: 'I & II STD - 75 Mts', price: '₹550'),
    TicketItem(title: 'III STD - 100 Mts', price: '₹550'),
    TicketItem(title: 'IV STD - 200 Mts', price: '₹700'),
    TicketItem(title: 'V STD - 300 Mts', price: '₹550'),
    TicketItem(title: 'VI, VII & VIII STD - 400 Mts', price: '₹550'),
    TicketItem(title: 'Open Category 400 Mts (MOM)', price: '₹1000'),
    TicketItem(title: 'Open Category 400 Mts (DAD)', price: '₹1000'),
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('CHENNAI KIDATHON 2026',
                style: TextStyle(
                    fontSize: 13,
                    fontWeight: FontWeight.w900,
                    color: kBlackText)),
            Text('Sun, 2 Aug | 7 AM • Chennai',
                style: TextStyle(fontSize: 11, color: kSubText)),
          ],
        ),
      ),
      bottomNavigationBar:
          _totalItems > 0 ? _CheckoutBar(total: _totalPrice, items: _totalItems) : null,
      body: ListView(
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child:
                            const Icon(Icons.remove, size: 16, color: kBlackText),
                      ),
                    ),
                    Padding(
