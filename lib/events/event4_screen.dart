...
const _kEventTitle    = 'CHENNAI RISE UP RUN - FUN & AWARENESS MARATHON 2026';
const _kEventDate     = 'Sun, 24 May 2026 | 5:30 AM';
const _kEventLocation = 'Decathlon - Mogappair, Chennai';
const _kEventUrl      = 'https://mrcoach.in/events/chennai-rise-up-run-2026';
const _kShareText     =
...
class Event4DetailPage extends StatefulWidget {
  final bool isBookmarked;
  final ValueChanged<bool>? onBookmarkChanged;

  const Event4DetailPage({
    super.key,
  ...
  @override
  State<Event4DetailPage> createState() => _Event4DetailPageState();
}

class _Event4DetailPageState extends State<Event4DetailPage> {
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 6),
                        Text(
                          '115/1 Service Road, West Mogappair, near Turn & Twist, Nolambur, Chennai, Tamil Nadu 600058',
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    final Uri googleMapsApp = Uri.parse(
                        'google.navigation:q=13.0840,80.1609&mode=d');
                    final Uri googleMapsBrowser = Uri.parse(
                        'https://www.google.com/maps/dir//Decathlon+Sports+-+Nolambur,+No.+115%2F1+Service+Road,+West+Mogappair,+near+Turn+%26+Twist,+Nolambur,+Chennai,+Tamil+Nadu+600058');
  ...
  void _showScheduleSheet(BuildContext context) {
    final items = [
      ScheduleItem('Reporting Time', '5:30 AM'),
      ScheduleItem('Warm-up Session', '5:45 AM'),
      ScheduleItem('Marathon Starts', '6:15 AM'),
    ];
          ...
          children: [
            ...
            Expanded(
              child: ListView(
                ...
                children: const [
                  _TermsItem(
                      '🎉🎉 CHENNAI RISE UP RUN - FUN & AWARENESS MARATHON 2026\n\n✨ Presented by SPORTENA ACADEMY'),
                  _TermsItem(
                      'About the Event\n\nChennai Rise Up Run 2026 is a fun-filled running event designed to promote fitness, community, and awareness. Open to all ages and fitness levels.'),
                  _TermsItem(
                      'The event encourages participants to stay active, build endurance, and enjoy the thrill of participating in a professionally organized race.'),
                  _TermsItem(
                      'With a safe and energetic environment, runners will experience the joy of running, cheering, and achieving their goals.'),
                  _TermsItem(
      ...
      body: Stack(
        children: [
          SizedBox(
            ...
            width: double.infinity,
            child: Image.asset('assets/images/chennaievent.jpeg',
                fit: BoxFit.cover),
          ),
          Positioned(
                      ...
                      child: Column(
                        children: [
                          _InfoTile(
                            ...
                            title: 'DECATHLON - MOGAPPAIR, CHENNAI',
                            subtitle: 'West Mogappair, Nolambur',
                            onTap: () => _showVenueSheet(context),
                          ),
                          const SizedBox(height: 10),
                          _InfoTile(
                            icon: Icons.calendar_month_outlined,
                            title: 'Reporting Time 5:30 AM',
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 12),
                          const Text(
                            '🎉🎉 CHENNAI RISE UP RUN - FUN & AWARENESS MARATHON 2026\n\n✨ Presented by SPORTENA ACADEMY\n\nJoin us for an exciting fun run at Decathlon Mogappair, Chennai. A morning of fitness, energy, and community spirit for runners of all ages!',
                            style: TextStyle(
                                fontSize: 14,
                                color: kSubText,
                                height: 1.6),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Divider(
                              color: kLightDivider, thickness: 0.5),
                          const SizedBox(height: 12),
                          _ThingsRow(Icons.directions_run,
...
class _ChooseTicketPageState extends State<ChooseTicketPage> {
  final List<TicketItem> _tickets = [
    TicketItem(
        title: '3 KM / 5 KM FUN MARATHON',
        subtitle: '',
        price: '₹299'),
    TicketItem(
        title: '5 KM TIMED MARATHON',
        subtitle: '',
        price: '₹499'),
  ];
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('CHENNAI RISE UP RUN - FUN & AWARENESS MARATHON',
                style: TextStyle(
                    fontSize: 13,
                    fontWeight: FontWeight.w900,
                    color: kBlackText)),
            Text('Sun, 24 May | 5:30 AM • Chennai',
